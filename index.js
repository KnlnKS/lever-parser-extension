     ...
     <label>
        <div>
           <a href="#" class="postings-btn template-btn-utility visible-resume-upload">
              ...
              <span class="filename"></span><span class="default-label">PARSE</span><input class="application-file-input-parser invisible-resume-upload" data-qa="input-resume" id="parse-resume-upload-input" name="resume" tabindex="-1" type="file">
           </a>
        </div>
     </label>
  </li>
